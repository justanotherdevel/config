...
// src/constants.ts
var CONFIG_GLOB = "{tailwind,tailwind.config,tailwind.*.config,tailwind.config.*}.{js,cjs}";
...
async function activate2(context) {
  ...
  async function didOpenTextDocument(document) {
    ...
    folder = getOuterMostWorkspaceFolder(folder);
    try {
      const configFiles = await (0, import_fast_glob.default)(import_path2.default.join(import_coc3.Uri.parse(folder.uri).fsPath, "**/" + CONFIG_GLOB), {
